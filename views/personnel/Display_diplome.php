      ...
      <div id="logo" style="background-color: white;opacity: 0.95; animation: fondu 15s ease-in-out infinite both; float:center; height:550px;padding: 10px;">                           
          ...
          <div class="row">
              ...
              <table class="table table-hover table-responsive table-striped">
                ...
                <?php foreach($liste_diplomes as $row) :?>
                <tr>
              ...
              <center><?php if($role=='admin_user'){ echo anchor('Diplome/show_add_diplome/'.$row->matricule,'<button class="btn btn-primary" style= "width : 230px; height : 45px; margin-top : 3px;">Ajouter un diplome</button>'); }?></center>
            </div>                               
          </div>
