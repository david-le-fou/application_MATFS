  ...
  <div class="col-sm-2 sidenav">
    ...
    <div class="col-sm-8"> 
      <div id="logo" style="background-color: white;opacity: 0.95; animation: fondu 15s ease-in-out infinite both; float:center; height:550px;padding: 10px;">                           
          ...
          <div class="row">
              <div class="col-md-12">
              <h3 style="height:40px; font-size:25px;"><center><u>Ajouter une cessation</u></center></h3>

              <?php echo form_open('Cessation/add_cessation'); ?>
              <form>           
                ...
                <table class="table table-hover table-responsive table-striped">
                  ...
                  <tr>
  	                  <td><input class="pers" type="text" name="cessation"></td>
  	                  <td><input class="pers" type="date" name="date_debut"></td>
  	                  <td><input class="pers" type="date" name="date_fin"></td>
