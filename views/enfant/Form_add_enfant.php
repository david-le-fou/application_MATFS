    ...
    <div class="col-sm-8"> 
      <div id="logo" style="background-color: white;opacity: 0.95; animation: fondu 15s ease-in-out infinite both; float:center; height:550px;padding: 10px;">                           
          ...
          <div class="row">
              ...
              <?php echo form_open('Enfant/add_enfant'); ?>
              <form>           
                ...
                <table class="table table-hover table-responsive table-striped">
                  ...
                  <tr>
  	                  <td><input class="pers" type="text" name="nom_enfant"></td>
  	                  <td><input class="pers" type="text" name="prenom_enfant"></td>
  	                  <td><input class="pers" type="date" name="date_enfant"></td>
  	                  <td><input class="pers" type="text" name="sexe_enfant"></td>
                  </tr>
